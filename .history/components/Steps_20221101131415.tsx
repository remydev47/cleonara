    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="relative mt-12 lg:mt-20">
            ...
            <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
                <div>
                    <div className="flex items-center justify-center w-60 h-60 mx-auto bg-white border-2 border-gray-200 shadow">
                ...
                <div>
                    <div className="flex items-center justify-center w-40 h-40 mx-auto bg-white border-2 border-gray-200 shadow">
                        <span className="text-xl font-semibold text-gray-700">
