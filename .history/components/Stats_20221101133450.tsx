...
const Stats = () => {
  return (
    <section className="py-10 bg-[#092341] sm:py-16 lg:py-24">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            <h4 className="text-4xl font-medium italic text-gray-100">Numbers tell the hard works we’ve done in last 10 years</h4>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 px-6 mt-8 sm:px-0 lg:mt-16 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-12">
            ...
            <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
                <div className="px-4 py-6">
                    <div className="flex items-start">
                        <img src='/images/quality.png' className='h-20 w-20' />
                        <div className="ml-4">
                            <h4 className="text-4xl font-bold text-gray-900">100%</h4>
                            <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">Quality</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
                <div className="px-4 py-6">
                    <div className="flex items-start">
                        <img src='/images/happy.png' className='h-20 w-20' />
                        <div className="ml-4">
                            <h4 className="text-4xl font-bold text-gray-900">2,374</h4>
                            <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">Happy Faces</p>
                        </div>
                    </div>
                </div>
            </div>
